...
class CifarClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        # Save the model
        model.save(
            f"/home/users/sardara/Revised_Approach/Results/FL/HHAR/FedProx/Transformer/experiment__{experiment}/round_{round_1}.h5",
...
for i in range(num_experiments):
    ...
    model.save(f"/home/users/sardara/Revised_Approach/Results/FL/HHAR/FedProx/Transformer/num_experiment_{round}.h5")
