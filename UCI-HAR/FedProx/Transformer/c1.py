...
train_path = r"/home/users/sardara/Revised_Approach/Datasets/UCI-HAR/train.csv"
test_path = r"/home/users/sardara/Revised_Approach/Datasets/UCI-HAR/test.csv"
...
df_train = df_train[df_train['subject'] == 1]
...
class CifarClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        global round_1  # Access global round counter
        # Set model weights
        model.set_weights(parameters)
        # Evaluate the model
        ...
        # Save the model
        model.save(
            f"/home/users/sardara/Revised_Approach/Results/FL/UCI-HAR/FedProx/Transformer/experiment__{experiment}/round_{round_1}.h5",
            include_optimizer=False,  # Save without optimizer state
        )
...
for i in range(num_experiments):
    ...
    model.save(f"/home/users/sardara/Revised_Approach/Results/FL/UCI-HAR/FedProx/Transformer/num_experiment_{round}.h5")
