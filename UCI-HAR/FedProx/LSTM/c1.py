...
class FLClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        global round_1
        round_1 = round_1 + 1
        model.save(f"/home/users/sardara/Revised_Approach/Results/FL/UCI-HAR/FedProx/LSTM/experiment__{experiment}/round_{round_1}.h5")
...
for i in range(num_experiments):
    ...
    model.save(f"/home/users/sardara/Revised_Approach/Results/FL/UCI-HAR/FedProx/LSTM/num_experiment_{round}.h5")
