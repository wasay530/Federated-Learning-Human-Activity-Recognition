...
def create_simple_transformer_model(input_shape, embed_dim=128, num_heads=4, ff_dim=256, maxlen=200):
    ...
    # Output Layer
    outputs = tf.keras.layers.Dense(units=6, activation="softmax")(x)  # Adjust output units based on your task
...
model = create_simple_transformer_model(input_shape=(25, 3))
