...
for i in range(num_experiments):
    ...
    strategy = fl.server.strategy.FedAvg(
        min_fit_clients=21,        # Require at least 2 clients to participate in the training phase
        min_available_clients=21   # Ensure at least 2 clients are available before starting the round
    )
