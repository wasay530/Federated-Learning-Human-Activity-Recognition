...
df_train = df_train[df_train['user'] == 3]
...
class CifarClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        # Save the model
        model.save(
            f"/home/users/sardara/Revised_Approach/Results/FL/WISDM/FedAdam/Transformer/experiment__{experiment}/round_{round_1}.h5",
...
for i in range(num_experiments):
    ...
    model = create_simple_transformer_model(input_shape=x_train.shape[1:])
    ...
    model.save(f"/home/users/sardara/Revised_Approach/Results/FL/WISDM/FedAdam/Transformer/num_experiment_{round}.h5")
